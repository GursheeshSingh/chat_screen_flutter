      ...
      return ConstrainedBox(
        ...
        child: Padding(
          ...
          child: Material(
            ...
            color: isFromSignedInUser! ? Theme.of(context).primaryColor : Theme.of(context).colorScheme.onBackground,
            child: Padding(
              ...
              child: Text(
                ...
                maxLines: null,
                style: TextStyle(
                  color: isFromSignedInUser! ? Theme.of(context).colorScheme.secondary : Theme.of(context).colorScheme.onSurface,
                ),
              ),
            ),
          ),
