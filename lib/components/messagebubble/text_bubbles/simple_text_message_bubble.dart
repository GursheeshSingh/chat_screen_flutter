      ...
      return ConstrainedBox(
        ...
        child: Padding(
          ...
          child: Material(
            ...
            color: isFromSignedInUser! ? Theme.of(context).primaryColor : Theme.of(context).accentColor,
            child: Padding(
              ...
              child: Text(
                ...
                maxLines: null,
                style: TextStyle(
                  color: isFromSignedInUser! ? Theme.of(context).accentColor : Theme.of(context).primaryColor,
                ),
              ),
            ),
          ),
